...
PROJECT_DIR="/home/bryt/sites/$PROJECT_NAME" # Change 'ubuntu' if your server uses a different directory structure
DOMAIN="teckstyle.com" # Replace with actual domain
USER="bryt"           # Replace with your actual server username
GUNICORN_WORKERS=3
